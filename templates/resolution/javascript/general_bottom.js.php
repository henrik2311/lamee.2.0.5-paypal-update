...
*/
  ...
  /**
  |--------------------------------------------------------------------------
  | JAVASCRIPT BOTTOM | SCRIPTS
  |--------------------------------------------------------------------------
  |
  | Globale Einbindung benoetigter Javascripts.
  |
  */
  ?>
  <?php if (isset($hook->hook_general_bottom_js_php_top))(eval($hook->hook_general_bottom_js_php_top)); ?>

  <?php
  /**
  |--------------------------------------------------------------------------
  | JAVASCRIPT BOTTOM | PAGE-SPECIFIC JAVASCRIPT
  |--------------------------------------------------------------------------
  |
  | Diese Datei wird im botto jeder Seite eingebunden. Template spezifisches
  | Javascrip sollte hier eingefuegt werden...
  |
   */
  ?>
  <?php require DIR_FS_CATALOG . DIR_TMPL_JS . 'default/get_states.js.php'; ?>
...
<?php if (strstr($PHP_SELF, FILENAME_CONTENT) && $_GET['coID'] == 8) { ?>
  ...
  <![endif]-->
<?php } ?>
<?php if (isset($hook->hook_general_bottom_js_php_bottom))(eval($hook->hook_general_bottom_js_php_bottom)); ?>
