...
/* --------------------------------------------------------------
  ...
  // global defines
  define('DIR_FS_DOCUMENT_ROOT', '/kunden/383190_26123/webseiten/shop/live/'); // absolut path required
  ...
  define('DB_SERVER', 'mysql5.lamee.domainfactory-kunde.de'); // eg, localhost - should not be empty for productive servers
  define('DB_SERVER_USERNAME', 'db383190_2');
  define('DB_SERVER_PASSWORD', 'devS7LGhpEHgiUG');
  define('DB_DATABASE', 'db383190_2');
  ...
  // server
  defined('HTTP_SERVER') or define('HTTP_SERVER', 'http://www.lamee.de'); // eg, http://localhost - should not be empty for productive servers
  defined('HTTPS_SERVER') or define('HTTPS_SERVER', 'https://www.lamee.de'); // eg, https://localhost - should not be empty for productive servers
