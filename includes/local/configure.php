...
/* --------------------------------------------------------------
  ...
  // global defines
  define('DIR_FS_DOCUMENT_ROOT', '/Applications/MAMP/htdocs/lamee-modified-2.0.4/'); // absolut path required
  ...
  define('DB_DATABASE', 'lamee-mod-2.0.4');
  ...
  // server
  defined('HTTP_SERVER') or define('HTTP_SERVER', 'http://localhost:8888/lamee-modified-2.0.4/'); // eg, http://localhost - should not be empty for productive servers
  defined('HTTPS_SERVER') or define('HTTPS_SERVER', 'https://localhost:8888/lamee-modified-2.0.4/'); // eg, https://localhost - should not be empty for productive servers
